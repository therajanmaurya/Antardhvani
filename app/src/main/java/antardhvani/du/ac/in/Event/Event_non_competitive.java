...
public class Event_non_competitive extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (bundle.getInt("position") == 0) {
            ...
            ExpListItems1 = SetStandardGroups(getResources().getStringArray(R.array.competitiveHeads), getResources().getStringArray(R.array.competitive));
            ...
            ExpListItems2 = SetStandardGroups(getResources().getStringArray(R.array.specialHeads), getResources().getStringArray(R.array.special));
