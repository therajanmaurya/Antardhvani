...
public class Event_non_competitive extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String [][] non_competitive1 = {{"This special area gathers various new initiatives at the University which have introduced a\n" +
        ...
        ,{"More than 1500 international students ﬁom about 65 diiferent countries are currently\n" +
                ...
                "Dr.Girish Munjal (girishmun|al2012@gmail.com)"}
                ,{"Entrepreneurship Plaza\n" +
                ...
                "Coordinator: Prof. JM Khurana, Dean Students Welfare (|'mkhurana1@1ahoo.eo.in)"}
        ,{"Adventure Sports: An Introduction to Mountaineering.\n" +
        ...
        ,{"Equal Opportunity Cell\n" +
                ...
                "Dr. Anil Aneja (osd@eoc.du.ac.in)"}
        ,{"Govt of India Institutions\n" +
                ...
                "Dr. Aarati Saxena (aaratisaxena@gmail.com)"}
        ,{"No Data Available"}
        ,{"No Data Available"}
        ,{"Heritage Walk & Delhi University Archive Tour\n" +
        ...
        ,{"Delhi University Women's Association (DUWA)\n" +
                ...
                "Coordinator: to be appointed by President, DUWA"}
        ,{"Teacher training and Academic Orientation:\n" +
                ...
                "Coordinator: Qg._ Vijaya Laxmi Singh; (ddvijayaIaxmisingh@gmail.com)"}
        ,{"No Data Available"}};

        exo = new Event_non_competitive_adapter( getActivity() , non_competitive,non_competitive1);
        exap.setAdapter(exo);
