 ...
 */
public class Schedule_22nd_FEBRUARY_2015 extends Fragment {
    ...
    public static Schedule_22nd_FEBRUARY_2015 getInstance(int position) {
        Schedule_22nd_FEBRUARY_2015 myFragment = new Schedule_22nd_FEBRUARY_2015();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (bundle.getInt("position") == 0) {
            ...
            ExpListItems = SetStandardGroups(getResources().getStringArray(R.array.day31));
            ...
            ExpListItems1 = SetStandardGroups(getResources().getStringArray(R.array.day32));
            ...
            ExpListItems2 = SetStandardGroups(getResources().getStringArray(R.array.day33));
            ...
            ExpListItems3 = SetStandardGroups(getResources().getStringArray(R.array.day34));
            ...
            ExpListItems4 = SetStandardGroups(getResources().getStringArray(R.array.day35));
            ...
            ExpListItems5 = SetStandardGroups(getResources().getStringArray(R.array.day36));
            ...
            ExpListItems6 = SetStandardGroups(getResources().getStringArray(R.array.day37));
