 ...
 */
public class Schedule_21st_Feb_2015 extends Fragment {
    ...
    public static Schedule_21st_Feb_2015 getInstance(int position) {
        Schedule_21st_Feb_2015 myFragment = new Schedule_21st_Feb_2015();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (bundle.getInt("position") == 0) {
            ...
            ExpListItems = SetStandardGroups(getResources().getStringArray(R.array.day21));
            ...
            ExpListItems1 = SetStandardGroups(getResources().getStringArray(R.array.day22));
            ...
            ExpListItems2 = SetStandardGroups(getResources().getStringArray(R.array.day23));
            ...
            ExpListItems3 = SetStandardGroups(getResources().getStringArray(R.array.day24));
            ...
            ExpListItems4 = SetStandardGroups(getResources().getStringArray(R.array.day25));
            ...
            ExpListItems5 = SetStandardGroups(getResources().getStringArray(R.array.day26));
            ...
            ExpListItems6 = SetStandardGroups(getResources().getStringArray(R.array.day27));
